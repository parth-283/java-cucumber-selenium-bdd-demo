...
public class RegisterSteps {
	...
	public void the_user_is_on_the_registration_page() {
		driver = webDriverFactory.getDriver("/register");
	...
	@Then("the user should remain on the registration page {string}")
	public void the_user_should_remain_on_the_registration_page(String URL) {
		try {
